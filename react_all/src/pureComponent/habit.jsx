...
class Habit extends PureComponent {
    ...
    */
    ...
    handleModify = () => {
        this.props.onModify(this.props.habit);
    };
    render() {
        ...
        return (
            <li className='habit'>
                ...
                <button
                    className='habit-btn habit-increase common-habit-btn'
                    onClick={this.handleIncrement}
                >
                    +
                </button>
                <button
                    className='habit-btn habit-decrease common-habit-btn'
                    onClick={this.handleDecrement}
                >
                    -
                </button>
                <button
                    className='habit-btn habit-modify common-habit-btn'
                    onClick={this.handleModify}
                >
                    =
                </button>
                <button
                    className='habit-btn habit-delete common-habit-btn'
